...
| 层级 | 文件位置 | 目标数量 | 已实现 | 状态 |
|---|---|---|---|---|
| 单元测试 | `crates/*/src/tests.rs` | 每 crate | 0 | ⬜ 未开始 |
| 1:1 方法测试 | `crates/sa-token-test/tests/1to1/*.rs` | ~150 | 0 | ⬜ 未开始 |
| Golden 测试 | `crates/sa-token-test/tests/golden/*.rs` | ~50 | 0 | ⬜ 未开始 |
| Parity 测试 | `crates/sa-token-test/tests/parity/*.rs` | ~100 | 0 | ⬜ 未开始 |
...
- **easyexcel-rs 测试**：`/Users/wandl/workspaces/workspace-github/easyexcel-rs/crates/easyexcel/tests/`（88 golden + 152 parity）
